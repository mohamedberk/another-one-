    ...
    <div id="about" className="max-w-[1440px] mx-auto px-2 sm:px-6 lg:px-8 my-6">
      <div className="py-4 sm:py-8 bg-white/70 backdrop-blur-md rounded-xl overflow-hidden relative border border-gray-100 shadow-lg">
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-2 sm:px-6 lg:px-8">
          ...
          {/* Headline */}
          <h2 className="text-lg sm:text-2xl md:text-3xl font-bold text-center mb-1 sm:mb-2 font-display bg-gradient-to-r from-amber-600 to-orange-600 bg-clip-text text-transparent tracking-tight">
          ...
          {/* Luxe card layout: compact squares on mobile, grid on desktop */}
          <div className="grid grid-cols-2 gap-2 sm:grid-cols-2 lg:grid-cols-3 sm:gap-6">
            {/* Card 1 */}
            <div className="min-w-0 aspect-square sm:aspect-auto bg-white/80 backdrop-blur-lg rounded-xl p-2 sm:p-4 shadow-xl border border-amber-100/60 flex flex-col items-center justify-center text-center snap-center transition-all duration-300 hover:-translate-y-1 hover:shadow-2xl animate-fadeIn">
