      ...
      <div className="relative">
        <div className="text-center mb-8 sm:mb-12">
          <div className="flex items-center justify-center gap-2 mb-3">
            <div className="h-8 w-1 bg-orange-700 rounded-full shadow-sm"></div>
            <span className="text-orange-700 uppercase tracking-widest text-xs font-semibold">Why Choose Us</span>
          </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6 lg:gap-8">
          {features.map((feature, index) => (
            <div 
              key={index} 
              className="bg-white rounded-xl p-4 sm:p-6 shadow-sm hover:shadow-xl border border-orange-100/50 transition-all duration-500 hover:-translate-y-1 group"
            >
              <div className="bg-orange-50 p-3 rounded-lg w-fit mb-4 group-hover:bg-orange-100 transition-all duration-300">
                {feature.icon}
              </div>
              <h3 className="text-lg sm:text-xl font-semibold mb-2 group-hover:text-orange-700 transition-colors duration-300">
                {feature.title}
              </h3>
